...
#code for aws terminal 
# aws s3 sync s3://sf-sleep-study/ '/mnt/home/mhacohen/ceph/Sleep_study/SubjectsData/withings' --profile mhacohen --region us-east-1
        ...
        with zipfile.ZipFile(input_zip, 'r') as zip_ref:
            ...
            for file in os.listdir(input_folder_wit):
                if file in ['raw_bed_Pressure.csv','raw_bed_HR RMS SD.csv',
                    ...
                    for datei in dfi['date_corrected'].unique():
                        file_name = ''
