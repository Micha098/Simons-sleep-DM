    ...
    if path_edf:
        try:
            ...
            if utc_flag == True:
                ...
                test_dir = '/mnt/home/mhacohen/test_eeg.edf'
                rename_dict = {
                    'Accelero Norm': 'AccNorm',
                    'EEG F7-O1': 'F7-O1',
                    'EEG F8-O2': 'F8-O2',
                    'EEG F8-F7': 'F8-F7',
                    'EEG F8-O1': 'F8-O1',
                    'EEG F7-O2': 'F7-O2',
                    'Positiongram': 'Position',
                    'Respiration x': 'Resp_x',
                    'Respiration y': 'Resp_y',
                    'Respiration z': 'Resp_z'
                }
                EEG.rename_channels(rename_dict)
                ...
                psg_channels = [ch for ch, ch_type in channel_types.items() if ch_type != 'stim']
                EEG = EEG.copy().pick_channels(psg_channels)
