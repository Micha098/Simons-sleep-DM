...
unique_cases = pd.read_csv('/mnt/home/user/Participants and devices - Dreem corrections.csv')
...
def dreem_allocation():
    ...
    data_check = pd.read_csv('/mnt/home/user/Participants and devices - Dreem data check.csv')[['User ID','starting date','ending date','Dreem user id']]
