...
def eda_raw_data(i):
    ...
    tz_temp = f'/mnt/home/mhacohen/ceph/Sleep_study/SubjectsData/raw_data/data_share/{subject_id[i]}/empatica/raw_data/eda/tz_temp' #output folder
    
    output_folder = f'/mnt/home/mhacohen/ceph/Sleep_study/SubjectsData/data_share/{subject_id[i]}/empatica/raw_data/eda/' #output folder
